    ...
    <div style={{ marginTop: '50px' }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="form">
        ...
        <label>
          ...
          <div style={{ height: 40 }}>
            {errors?.first_name && (
              <p className="error">{errors?.first_name?.message || 'Error!'}</p>
            )}
          </div>
        </label>
        {/* Last Name */}
        <label>
          ...
          <div style={{ height: 40 }}>
            {errors?.last_name && (
              <p className="error">{errors?.last_name?.message || 'Error!'}</p>
            )}
          </div>
        </label>
        {/* Email */}
        ...
        <label>
          ...
          <div style={{ height: 40 }}>
            {errors?.username && (
              <p className="error">{errors?.username?.message || 'Error!'}</p>
            )}
          </div>
        </label>
                ...
                {...register('password', {
                  ...
                  pattern: {
                    value:
                      /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}$/,
                    message:
                      'Пароль должен содержать по крайней мере одну прописную букву, одну строчную букву, одну цифру и один специальный символ (!@#$%^&*)',
                  },
                })}
          ...
          <div className="password__input">
            ...
            <div className="password__field">
              ...
              <img
                ...
                src={showConfirmPassword ? '/img/eye.svg' : '/img/eye-off.svg'}
              />
            </div>
          </div>
        ...
        <select
          ...
          {...register('age_limit', { required: 'Выберите возраст' })}
        >
        ...
        <label className="accept__label">
          <input {...register('accept_rules')} type="checkbox" />
        ...
        <ReCAPTCHA
          className="captcha"
          sitekey="6LfZm-YqAAAAAHaMS4sYc1_poVr6mcyCLsaayqRD"
        ...
        <input
          ...
          disabled={!isValid || !captchaPassed}
        />
