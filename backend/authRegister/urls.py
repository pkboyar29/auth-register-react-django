...
from .views import UserRegistrationView, UserAuthView, UserDetailView, UserChangeTheme, UserCheckRecaptchaToken
...
urlpatterns = [
   ...
   path('checkToken', UserCheckRecaptchaToken.as_view(), name='check-recaptchaToken')
]